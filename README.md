...
- Security-oriented system investigation  
...
├── Linux Networking Lab.md (coming soon)
├── Linux Log Analysis Report.md (coming soon)
└── scripts/ (bash scripts will be added)
...
If you are a beginner in cybersecurity, these notes can serve as a reference and learning path.
